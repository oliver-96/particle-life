...
from setup_schema import CELL_SIZE, START_X, START_Y, SLIDER_DIMENSIONS, LABEL_DIMENSIONS
...
map_y_offset = 200
slider_y_offset = 90
colour_square_y_offset = 42

button_start_x = START_X + button_x_offset
button_start_y = START_Y + button_y_offset
